...
const Footer = () => {
    return (
        <View style={stylesFooter.container}>
            ...
            <View>
                <TouchableOpacity style={stylesFooter.btn}>
                    <Image source={require('../../assets/icons/footer/download.png')} resizeMode={'center'} style={stylesFooter.btnIcon} />
                </TouchableOpacity>
            </View>
            ...
            <View>
                <TouchableOpacity style={stylesFooter.profileBtn}>
                    <Image source={require('../../assets/icons/footer/profile.png')} resizeMode={'stretch'} style={stylesFooter.profileIcon} />
                </TouchableOpacity>
